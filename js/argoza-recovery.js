(() => {
  ...
  const sequence = [
    ...
    narrative(['A low mechanical hum. Air moving through vents. A faint electronic pulse somewhere nearby.','Then a breath.','Another.']),
    narrative(['Cold returns first.','Then weight.','Then memory.']),
    narrative(['The Argoza.','Ellison-Tanaka.','Transit.','A station somewhere very far away.']),
    narrative(['Light seeps through the translucent cover above you. A soft tone sounds.','The lid unlocks.','Around the cryogenic bay, other pods begin the same sequence.']),
    ...
    narrative(['The pod opens.','Cold air spills over the edge.','And then the obvious thought arrives.']),
    narrative('You shouldn’t be awake yet.',{className:'is-dramatic',finalHold:3750}),
    narrative(['Across the bay, two other pods open.','Renfield sits upright, blinking against the light. Anders grips the edge of her pod and waits for the room to stop moving.','Neither of them looks any more informed than you feel.']),
    ...
    narrative(['As feeling returns to your legs, the bay comes back to life around you. Fans cycle overhead. Status lights shift from amber to green.','Another cryogenic pod stands nearby.','Open.','Empty.','Its display is still illuminated.']),
    ...
    narrative(['The cryogenic bay grows quiet again.','Maas’s open pod remains behind.','Outside, the Argoza continues toward a world none of you expected to see.','There are still several days before arrival.','For now, the ship is yours.']),
