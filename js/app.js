(() => {
  ...
  function fitArgozaMapFrame(frame){
    ...
    const sourceWidth=Number(frame.dataset.mapWidth),sourceHeight=Number(frame.dataset.mapHeight);
    ...
    coordinateSpace.style.height=`${sourceHeight*scale}px`;
  }
  ...
  function initArgozaMapCoordinateSpaces(){
    ...
    frames.forEach(fitArgozaMapFrame);
